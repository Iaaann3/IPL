...
<body>
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-top">
                <div class="profile-info">
                    <h1>Andrian Ramdani</h1>
                    <div class="house-number">No. Rumah : D15 Luas 79m²</div>
                </div>
        ...
        <div class="profile-details">
            ...
            <div class="detail-item loading">
                <div class="detail-value">iann@gmail.com</div>
                <div class="detail-label">E-mail</div>
            </div>

            <div class="detail-item loading">
                <div class="detail-value">Pesona Prima 8 Banjaran Blok B No 2</div>
                ...
                <div class="stats-cards">
                    <div class="stat-card loading">
                        ...
                        <div class="stat-content">
                            <div class="stat-number" id="iklanNumber">0</div>
                    ...
                    <div class="stat-card loading">
                        ...
                        <div class="stat-content">
                            <div class="stat-number" id="kritikNumber">0</div>
